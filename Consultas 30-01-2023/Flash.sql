...
WHERE
F.DATA BETWEEN '{DTINI}' AND '{DTFINI}'
AND
...
AND
G.CONDVENDA <> 5
),0)/*mud*//{DIASCORRIDOS} /*dias corridos*/)*{DIASUTEIS} /*diasuteis*/)/
...
)/({DIASUTEIS}-{DIASCORRIDOS}) MEDIANEC
